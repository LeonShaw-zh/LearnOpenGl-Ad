...
int main()
{
    ...
    Shader shader("../src/shader/4.1.depth.vs", "../src/shader/4.1.depth.fs");
    shader.use();
    shader.setInt("texture1", 0);

    unsigned int cubeVAO = makeCube();
    unsigned int planVAO = makePlane();
    unsigned int cubeTexture  = loadTexture("../src/tex/container.jpg");
